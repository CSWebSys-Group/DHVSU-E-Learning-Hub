...
const Login = () => {
  ...
  const handleLoginSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(JSON.stringify(data.error) || "Error signing up");
      }
          ...
          <div className="w-full rounded-l-[8rem] p-8 bg-maroon flex justify-center items-center backdrop-filter backdrop-blur-lg">
            <div className="flex flex-col justify-center items-center gap-6">
              ...
              <p className="text-sm font-poppins text-white font-light">
                ...
                est reiciendis aspernatur a. Iusto, nisi quos obcaecati quasi
                similique, illo recusandae quae autem vel eveniet officiis dicta
                vitae nostrum dolorem.
              </p>
