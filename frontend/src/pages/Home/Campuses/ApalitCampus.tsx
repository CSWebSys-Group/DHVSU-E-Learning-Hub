...
type College = {
  ...
  logo: string;
  title: string;
  courses: string[] | Course[]; // It could be either a list of strings or Course objects
};

const collegesApalit: College[] = [
  {
    id: 1,
    logo: cbsLogo,
...
const ApalitCampus = () => {
  return (
    <div className="px-[20px] py-[20px] flex flex-col gap-5 max-w-screen-xl mx-auto justify-center items-center mb-10 md:mt-7 md:gap-8 lg:mt-20 lg:gap-16">
      {collegesApalit.map((college, index) => (
        <div
          key={college.id}
